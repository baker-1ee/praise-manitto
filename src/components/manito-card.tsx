...
export function ManitoCard({ target, sprintName }: ManitoCardProps) {
  ...
  if (!target) {
    return (
      <div className="flex flex-col items-center justify-center h-36 rounded-xl border border-[rgba(28,26,23,0.12)] text-muted-foreground gap-3 bg-secondary">
  ...
  return (
    ...
    >
      ...
      >
        {/* 앞면 */}
        <div className="absolute inset-0 backface-hidden rounded-xl border border-[rgba(28,26,23,0.15)] bg-secondary flex items-center gap-5 px-6">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl bg-card border border-[rgba(28,26,23,0.12)]">
        ...
        {/* 뒷면 */}
        <div className="absolute inset-0 backface-hidden rotate-y-180 rounded-xl border border-primary/30 bg-card flex items-center gap-5 px-6">
          <Avatar className="h-12 w-12 shrink-0 border-2 border-primary/20">
            {target.avatarUrl && <AvatarImage src={target.avatarUrl} />}
            <AvatarFallback className="text-base bg-[#FEF0EA] text-primary font-semibold">
          ...
          <div>
            {isDizzy ? (
              ...
              <>
                ...
                <p className="font-serif font-bold text-xl text-primary tracking-subheading">{target.name}</p>
